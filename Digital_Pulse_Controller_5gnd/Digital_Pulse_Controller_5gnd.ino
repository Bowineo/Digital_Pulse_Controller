...
int configIO = 0;         //Variavel para armazenar tipo de configuração de acionamento HIGH/LOW
    ...
    if (receptor.decode(&resultado))
    {
        ...
        #pragma region Power, Up & Down, Rec and Stop
           ...
           case (0x61D618E7):
            ...
            lcd.clear();
            Line1("Configuration", 0);
            Line2(myS, 0);
            Serial.println("REC acionado - Configuração atual: " + myS);
            delay(2000);
...
void DigitalIO(String sl, int in)
{
    if (sl == "PRI")
    {
        ...
        {
        case (1):
            EscrevaSaida(22, configIO);
            obito = "22";
            break;
        case (2):
            EscrevaSaida(23, configIO);
            obito = "23";
            break;
        case (3):
            EscrevaSaida(24, configIO);
            obito = "24";
            break;
        case (4):
            EscrevaSaida(25, configIO);
            obito = "25";
            break;
        case (5):
            EscrevaSaida(26, configIO);
            obito = "26";
            break;
        case (6):
            EscrevaSaida(27, configIO);
            obito = "27";
            break;
        case (7):
            EscrevaSaida(28, configIO);
            obito = "28";
            break;
        case (8):
            EscrevaSaida(29, configIO);
            obito = "29";
            break;
        case (9):
            EscrevaSaida(30, configIO);
            obito = "30";
            break;
        case (10):
            EscrevaSaida(31, configIO);
            obito = "31";
            break;
        case (11):
            EscrevaSaida(32, configIO);
            obito = "32";
            break;
        case (12):
            EscrevaSaida(33, configIO);
            obito = "33";
            break;
        case (13):
            EscrevaSaida(34, configIO);
            obito = "34";
            break;
        case (14):
            EscrevaSaida(35, configIO);
            obito = "35";
            break;
        case (15):
            EscrevaSaida(36, configIO);
            obito = "36";
            break;
        case (16):
            EscrevaSaida(37, configIO);
            obito = "37";
            break;
        }
    }
    else
    {
        ...
        {
        case (1):
            EscrevaSaida(38, configIO);
            obito1 = "38";
            break;
        case (2):
            EscrevaSaida(39, configIO);
            obito1 = "39";
            break;
        case (3):
            EscrevaSaida(40, configIO);
            obito1 = "40";
            break;
        case (4):
            EscrevaSaida(20, configIO);
            obito1 = "20";
            break;
        case (5):
            EscrevaSaida(42, configIO);
            obito1 = "42";
            break;
        case (6):
            EscrevaSaida(21, configIO);
            obito1 = "21";
            break;
        case (7):
            EscrevaSaida(44, configIO);
            obito1 = "44";
            break;
        case (8):
            EscrevaSaida(45, configIO);
            obito1 = "45";
            break;
        case (9):
            EscrevaSaida(46, configIO);
            obito1 = "46";
            break;
        case (10):
            EscrevaSaida(47, configIO);
            obito1 = "47";
            break;
        case (11):
            EscrevaSaida(48, configIO);
            obito1 = "48";
            break;
        case (12):
            EscrevaSaida(49, configIO);
            obito1 = "49";
            break;
        case (13):
            EscrevaSaida(50, configIO);
            obito1 = "50";
            break;
        case (14):
            EscrevaSaida(51, configIO);
            obito1 = "51";
            break;
        case (15):
            EscrevaSaida(52, configIO);
            obito1 = "52";
            break;
        case (16):
            EscrevaSaida(53, configIO);
            obito1 = "53";
            break;
        }
    }
...
void ZeraSaidasLow()
{
    ...
    //MsgAnimed("_LOW_");
    Serial.println("As saidas foram desativadas! Low"); //Debug
}
...
void ZeraSaidasHigh()
{
    ...
    //MsgAnimed("_LOW_");
    Serial.println("As saidas foram desativadas! High"); //Debug
}

//Função que escreve(HIGH) na saida que é o parametro de entrada
void EscrevaSaida(int num, int x)
{
    if (x == 0)
    {
        EscrevaSaidaHigh(num);
    }
    else
    {
        EscrevaSaidaLow(num);
...
//Função que escreve(lOW) na saida que é o parametro de entrada
void EscrevaSaidaLow(int num)
{
    String myString = String(num);
    digitalWrite(num, LOW);                                   //Escreva na saida selecionada.
    Serial.println("Arduino out: " + myString + " Acionada!"); //Debug
...
void ConfigIOInput()
{
    //Definindo os pinos de saida como input.
    pinMode(20, INPUT);
    pinMode(21, INPUT);
    pinMode(22, INPUT);
    pinMode(23, INPUT);
